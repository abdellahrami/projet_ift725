...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        if i+1 == 1:
            ...
            train_index = model_trainer.get_least_confidence(trainset=train_set,testset=test_set,index_list=indexs,out_size = int(num_train*0.1))
            indexs = [l for l in indexs if l not in train_index]

        model_trainer = CNNTrainTestManager(model=model_trainer.model,
                                            trainset=train_set,
                                            testset=test_set,
                                            batch_size=batch_size,
                                            loss_fn=nn.CrossEntropyLoss(),
        ...
        # print("Training {} on {} for {} epochs".format(
    ...
    print("accuracies for this training : ", accuracies)
    ax.plot(data_sizes, accuracies, '-o', label="accuracy on test set")
    plt.show()
